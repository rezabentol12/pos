  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-body">
        <?php echo form_open('user/Home/simpan', array('class'=>'form-horizontal')); ?>
    ...
    <div class="form-group">
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" name="submit" class="btn btn-primary btn-sm">Simpan</button> | <?php echo anchor('user/Home/selesai','Selesai',array('class'=>'btn btn-success btn-sm'))?>
      </div>
    </div>
  </form>
</div>
